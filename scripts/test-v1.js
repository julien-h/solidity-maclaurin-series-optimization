// This script compares the output and gas costs of the baseline contract and optmized v1
//
...
async function main() {
  ...
  const optimizedContract = await hre.ethers.getContractFactory("MBTestOptimized1");
